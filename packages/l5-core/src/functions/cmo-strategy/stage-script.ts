...
export const STAGE_SCRIPT: Record<VideoRoomStatus, StageGuidance> = {
  ...
  thumbnail_pattern_extraction: {
    label: '썸네일 구성',
    // PRD docs/prd/cmo-title-development.md §27.3: 제목 디벨롭 8단계를 이 단계 내부에서 수행(MVP).
    focus: '확정된 풀링 5개+키 콘텐츠 각각에 대해 Viewtrap 검증 레퍼런스 2개를 기반으로 제목을 8단계 디벨롭하고, 이후 썸네일 문구·감정 훅·구도 구조를 우리 주제에 맞게 치환한다.',
    prompt: '확정된 풀링 5개와 키 콘텐츠를 기준으로 제목·썸네일을 잡겠습니다. 먼저 각 콘텐츠와 같은 주제(없으면 같은 의미 범위)의 Viewtrap 검증 레퍼런스 2개를 입력해 주세요. 조건은 조회수 5만 이상, 성과도·기여도 Good/Great입니다. 레퍼런스 2개의 제목·썸네일 재료를 교차 조합해 제목 디벨롭 8단계를 거친 뒤, 썸네일 문구·감정 훅·구도 구조를 우리 주제에 맞게 치환하겠습니다.',
  },
  intro_30s_analysis: {
    label: '원고 도입부 30초',
