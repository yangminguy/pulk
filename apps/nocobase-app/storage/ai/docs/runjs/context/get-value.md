---
title: "ctx.getValue()"
description: "In JSField, JSItem, and other editable field contexts, returns the current value of the field. Use with `ctx.setValue(v)` for two-way binding with the form."
---
...
- [ctx.setValue()](/runjs/context/set-value.md): set current field value; use with getValue for two-way binding
- [ctx.form](/runjs/context/form.md): Ant Design Form instance for other fields
